 ...
 */
const SourceTag = ({ source, platform }: SourceTagProps) => (
  <span className="inline-flex items-center gap-1.5 rounded-full border border-divider px-2 py-0.5 text-xs text-muted">
